...
#define LOADREF_PORT_ADDR  (GPIOD_BaseAddress)  /**< LOADREF pin GPIO base address */
...
#define SCKEY_P1_A  (0x10)  /**< Single channel key Port 1: 1st key mask */
...
#define SCKEY_P2_KEY_COUNT  (2)  /**< Single channel key Port 2: Number of keys used (value from 0 to 8) */

#define SCKEY_P2_PORT_ADDR  (GPIOC_BaseAddress)  /**< Single channel key Port 2: GPIO base address */

#define SCKEY_P2_A  (0x80)	/**< Single channel key Port 2: 1st key mask */
#define SCKEY_P2_B  (0x40)  /**< Single channel key Port 2: 2nd key mask */
...
#define GPIOC_ELECTRODES_MASK  (0xC0)  /**< Electrodes mask for GPIOC */
#define GPIOD_ELECTRODES_MASK  (0x10)  /**< Electrodes mask for GPIOD */
...
#define RECALIBRATION_INTEGRATOR_DEFAULT  (250)  /**< Calibration integrator (value from 1 to 255) */
...
// Spread spectrum
#define SPREAD_SPECTRUM      	(3) /**< Spread spectrum. (=1) Add a variable delay between acquisitions */
